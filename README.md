# DeafVisionAI – A Public Proposal for AI-Driven Sign Language Accessibility

**Status:** Concept Proposal – Open to Collaboration  
**License:** GNU Affero General Public License v3.0 (AGPL-3.0)  
**Proposed by:** Dominik Dostál  
...
**DeafVisionAI** is an open-source proposal to create a real-time or pre-rendered AI accessibility layer that transforms spoken digital content — such as movies, podcasts, lectures, and livestreams — into native sign language through expressive, culturally aware avatars.

Unlike subtitles, which force Deaf users to rely on written translations of spoken grammar, this system aims to deliver **fluent, immersive, and emotionally accurate sign language representations**, matching both linguistic structure and tone. It can be deployed as a browser plug-in, API layer, or platform-side overlay — and is designed to work across **YouTube, Netflix, Spotify, Zoom, and more**.
...
It is a **public-good blueprint** — open for developers, researchers, NGOs, and accessibility advocates to build upon freely.
...
## ⚠️ Why Subtitles Are Not Enough

- Many Deaf users consider **sign language their first language** — not written text.
...
|--------|-------------------|---------------|
| Browser plug-in for real-time sign overlays | ✅ SignSync, SignUp | ✅ Planned |
| Multi-platform support (YouTube, podcasts, Netflix) | ❌ Partial | ✅ Core goal |
| Native sign language grammar handling (not word-for-word English) | ⚠️ Basic | ✅ Prioritized |
| Avatar customization (ethnicity, style, dialect) | ❌ Mostly fixed | ✅ Included |
| Open-source licensing with anti-enclosure protection | ⚠️ Some Apache, some closed | ✅ AGPL-3.0 |
| Designed as a public good with no corporate lock-in | ❌ Rare | ✅ Explicit mission |
...
I do not intend to build this myself due to other high-priority commitments — but I believe it should exist, and I invite others to take this idea forward.
...
- Commercial services can exist — but must remain open, share-alike, and accessible.
...
- [SignSync](https://github.com/SamChenYu/SignSync) – Chrome plugin using auto-captioned YouTube speech + avatar signing
- [SignVision.app](https://signvision.app) – EU-funded institutional tool for signed broadcasting and education
- [SignUp Chrome Extension](https://chromewebstore.google.com/detail/signup-sign-language-for/gbllbjbhbafgdcolenjhdoabdjjbjoom) – ASL overlays for Netflix and Disney+
- [Hand Talk Plugin](https://www.signfordeaf.com/solutions/web-sign-language) – Commercial site-embedded avatar solution
- [Sign Language Translator (GitHub)](https://github.com/sign-language-translator/sign-language-translator) – Library for structured sign grammar generation

DeafVisionAI aims to **synthesize and generalize** these ideas into a **flexible, scalable, and culturally respectful open system** — built by and for the community.
...
Open an issue, fork the repo, or email me. Let’s make this real.
